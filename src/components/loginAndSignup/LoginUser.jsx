      ...
      <form className="box_container_login2">
        <div className="cover">
          ...
          <div className="forgot_password">
            Forgot your password? <Link to={"/forgotPassword"} className="findpassword">Find password</Link>
          </div>
          ...
          <div className="googlebtn_btn">
            ...
            <div className="google_account">Sign up with your social media account</div>
